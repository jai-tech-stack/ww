  ...
  return (
    ...
    >
      <Head>
        ...
        {/* Webflow w-mod-js class init (runs before paint) */}
        <script
        ...
        {/* Webflow initial animation states â€” keeps elements hidden until JS runs */}
        <style>{`
html.w-mod-js:not(.w-mod-ix3) :is(.cta-top-wrapper-1,.cta-top-wrapper-2,.about-right-box,.service-tag-description-wrap){visibility:hidden!important;}
        ...
        {/* Favicon â€” uses the clean White Wolf icon */}
