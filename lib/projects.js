...
export const PROJECTS = [
  {
    slug: "vellin-studio",
    title: "Vellin Studio",
    tagline: "A premium eyewear brand blending style, precision, and modern identity.",
    category: "Branding",
    client: "Vellin Studio",
    year: "2025",
    duration: "5–6 weeks",
    budget: "$4,000",
    services: ["Brand Strategy", "Logo Design", "Visual Identity", "Brand Guidelines", "Art Direction"],
    ...
    overview:
      "Vellin Studio is a premium eyewear brand that needed a bold, modern identity to stand out in a competitive luxury market. We crafted a complete visual brand system — from logomark to brand guidelines — designed to resonate with a style-conscious global audience.",
    sections: [
      {
        type: "text",
        label: "Research",
        heading: "Understanding the landscape of premium eyewear",
        body: "We began by researching the crossroads of fashion, automotive design, and precision craftsmanship. Vellin Studio's founders had a clear vision: an eyewear brand that feels engineered, not just designed. This shaped every visual and strategic decision that followed.",
      },
      {
        type: "image-full",
      ...
      },
      {
        ...
        heading: "Maximising impact through focused identity",
        body: "The core challenge was differentiating Vellin Studio in a saturated premium market. The brand needed to communicate quality and exclusivity without relying on heritage — instead building credibility through design precision, consistent visual language, and a modern editorial tone.",
      },
      {
        type: "split",
        label: "Development",
        heading: "Building a brand system that scales",
        body: "We developed a complete identity system combining a precision-crafted logomark, a refined typographic hierarchy, and a carefully considered colour palette. The system was designed to be versatile — performing equally well on physical product, digital platforms, and editorial content.",
        image: "/assets/6928342afe049a8be49dd856_image 3 (2).svg",
      },
    ],
    results: [
      { stat: "60%", label: "Increase in client inquiries" },
      { stat: "3×",  label: "Social media engagement" },
