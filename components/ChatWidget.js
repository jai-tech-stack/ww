    ...
    <>
      ...
      >
        {open ? (
          ...
          <>
            <span className="ww-chat-fab-orb">
              <span className="ww-chat-fab-ping" />
              {/* AI sparkle */}
              <svg className="ww-chat-fab-spark" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="ww-chat-fab-text">
              <span className="ww-chat-fab-title">Chat with our AI</span>
              <span className="ww-chat-fab-sub"><span className="ww-chat-fab-dot" />Online · instant replies</span>
            </span>
          </>
        )}
      </button>
